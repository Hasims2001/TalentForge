...
export const InputDesign = ({ids, types,req=true, name, widths="100%", helperText, placeholderValue=" ", values=""}) => {
  return (
    <FormControl mb={6} variant="floating"  width={widths} isRequired={req } isInvalid>
